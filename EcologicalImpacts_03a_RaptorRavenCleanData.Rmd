...
*Methods*
Raven observations (n = 185) were greater than all raptor observations (n = 172).  
We excluded observations of short-eared owls (Asio flammeus), which are not known to scavenge or prey on ground squirrels or ground-nesting bird nests (n = 3). We also removed observations classified as unknown raptors (n = 6).   
*Results*
Within the 250m buffer around each 1-km2 grid, we observed:
ravens (n = 185),  
burrowing owls (Athene cunicularia, n = 17),  
ferruginous hawks (n = 7),  
golden eagles (Aquila chrysaetos, n = 8),  
northern harriers (Circus hudsonius, n = 61),  
prairie falcons (Falco mexicanus, n = 21),  
red-tailed hawks (n = 27),  
short-eared owls (n = 3),  
Swainson’s hawks (n = 17),  
and turkey vultures (Cathartes aura, n = 5).  
We also briefly observed several birds that could not be identified beyond being raptors (n = 6) or members of the Buteo genus (n = 6).
```{r}
